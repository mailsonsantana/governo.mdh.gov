...
class IGallerySwiperVideosTile(IListTile):
...
@implementer(IGallerySwiperVideosTile)
class GallerySwiperVideosTile(ListTile):
    """Display a gallery of videos."""

    is_configurable = True
    is_droppable = True
    is_editable = True
    short_name = _(u'msg_short_name_gallery_videos', default=u'Gallery Swiper Videos')
